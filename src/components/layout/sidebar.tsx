        ...
        <div className="shrink-0 border-t border-sidebar-border p-3">
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              side="top"
              sideOffset={6}
              className="min-w-56 bg-sidebar text-sidebar-foreground ring-sidebar-border"
            >
              <DropdownMenuItem
                render={
                  <Link
                    ...
                    onClick={onClose}
                    className="text-sidebar-foreground/80 focus:bg-sidebar-accent focus:text-sidebar-foreground"
                  />
                }
              >
